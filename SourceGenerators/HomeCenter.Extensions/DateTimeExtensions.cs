...
namespace HomeCenter.Extensions
{
    public static class DateTimeExtensions
    {
        ...
        public static TimeSpan Between(this DateTimeOffset currentPointInTime, DateTimeOffset previousPointInTime)
        {
            return currentPointInTime - previousPointInTime;
        }
        ...
        {
            return measuredTime <= comparedTime;
        }
        ...
        /// <param name="measuredTime"></param>
        /// <param name="comparedTime"></param>
        public static bool LastedLongerThen(this TimeSpan measuredTime, TimeSpan comparedTime)
        {
            return measuredTime > comparedTime;
        }
        ...
        public static bool IsPossible(this TimeSpan measuredTime, TimeSpan timeWindow)
        {
            return measuredTime >= timeWindow;
        }
        ...
        public static TimeSpan Increase(this TimeSpan time, double percentage)
        {
            return TimeSpan.FromTicks(time.Ticks + (long) (time.Ticks * (percentage / 100.0)));
        }
        ...
        {
            if (from < until) return givenTame >= @from && givenTame <= until;
