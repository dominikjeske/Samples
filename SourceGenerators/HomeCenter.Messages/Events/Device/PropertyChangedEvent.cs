...
namespace HomeCenter.Messages.Events.Device
{
    public class PropertyChangedEvent : Event
    {
        ...
        public static PropertyChangedEvent Create(string messageSource, string changedPropertyName, string oldValue,
            string newValue, IDictionary<string, string> additionalProperties = null)
        {
            return BuildEvent(messageSource, changedPropertyName, oldValue, newValue, additionalProperties);
        }

        public static PropertyChangedEvent Create(string messageSource, string changedPropertyName, bool oldValue,
            bool newValue, IDictionary<string, string> additionalProperties = null)
        {
            return BuildEvent(messageSource, changedPropertyName, oldValue.ToString(), newValue.ToString(),
                additionalProperties);
        }

        private static PropertyChangedEvent BuildEvent(string messageSource, string changedPropertyName,
            string oldValue, string newValue, IDictionary<string, string> additionalProperties)
        {
            ...
            if (oldValue != null) propertyChangedEvent.OldValue = oldValue;
